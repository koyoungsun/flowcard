<template>
  <section class="p-4 space-y-6">
    ...
    <div
      ...
      :key="index"
      class="border rounded p-4 space-y-2 bg-white shadow"
    >
    ...
    <div class="text-center">
      <button
        @click="addGroup"
        class="bg-indigo-500 text-white px-4 py-2 rounded text-sm"
      >
        + 새 그룹 추가
      </button>
    </div>
    ...
    <div class="text-right">
      <button
        @click="saveChanges"
        class="mt-6 bg-blue-500 text-white px-6 py-2 rounded text-sm font-medium"
      >
        저장 후 홈으로
      </button>
    </div>
